...
public class ProductCatalogController {
	...
	@DeleteMapping(value = "/productDelete/{productid}", consumes = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<?> deleteProduct(@PathVariable Integer productid) {

		Product product = catalogService.getProductById(productid);
		if (product == null) {
			return new ResponseEntity<String>("Product Id is not found, Try some other id", HttpStatus.NOT_FOUND);
		} else {
			catalogService.productDelete(productid);
		}
